...
template<typename T> class PASCALIMPLEMENTATION TFrameInfo__1 : public TSubjectInfo
{
	typedef TSubjectInfo inherited;
	
public:
	/* TSubjectInfo.Create */ inline __fastcall virtual TFrameInfo__1(TSubjectStand* const ASubjectStand, Fmx::Forms::TFrame* const ASubject, Fmx::Types::TFmxObject* const AParent, const System::UnicodeString AStandStyleName) : TSubjectInfo(ASubjectStand, ASubject, AParent, AStandStyleName) { }
...
// used only for accessing Delphi variables and fields.
// Don't instantiate with new type parameters in user code.
template<typename T> class PASCALIMPLEMENTATION TFormInfo__1 : public TSubjectInfo
{
	typedef TSubjectInfo inherited;
	
public:
	/* TSubjectInfo.Create */ inline __fastcall virtual TFormInfo__1(TSubjectStand* const ASubjectStand, Fmx::Forms::TFrame* const ASubject, Fmx::Types::TFmxObject* const AParent, const System::UnicodeString AStandStyleName) : TSubjectInfo(ASubjectStand, ASubject, AParent, AStandStyleName) { }
...
public:
	...
	TSubjectInfo* __fastcall Use(Fmx::Forms::TFrame* const ASubject, Fmx::Types::TFmxObject* const AParent = (Fmx::Types::TFmxObject*)(0x0), const System::UnicodeString AStandStyleName = System::UnicodeString())/* overload */;
	TSubjectInfo* __fastcall New(const TSubjectClass ASubjectClass, Fmx::Types::TFmxObject* const AParent = (Fmx::Types::TFmxObject*)(0x0), const System::UnicodeString AStandStyleName = System::UnicodeString())/* overload */;
	HIDESBASE void __fastcall Remove(Fmx::Forms::TFrame* ASubject)/* overload */;
...
class PASCALIMPLEMENTATION TFrameStand : public TSubjectStand
{
	typedef TSubjectStand inherited;
...
public:
	/* TSubjectStand.Create */ inline __fastcall virtual TFrameStand(System::Classes::TComponent* AOwner) : TSubjectStand(AOwner) { }
	/* TSubjectStand.Destroy */ inline __fastcall virtual ~TFrameStand() { }
	
	/* Hoisted overloads: */
	
public:
	inline TSubjectInfo* __fastcall  Use(Fmx::Forms::TFrame* const ASubject, Fmx::Types::TFmxObject* const AParent = (Fmx::Types::TFmxObject*)(0x0), const System::UnicodeString AStandStyleName = System::UnicodeString()){ return TSubjectStand::Use(ASubject, AParent, AStandStyleName); }
	inline TSubjectInfo* __fastcall  New(const TSubjectClass ASubjectClass, Fmx::Types::TFmxObject* const AParent = (Fmx::Types::TFmxObject*)(0x0), const System::UnicodeString AStandStyleName = System::UnicodeString()){ return TSubjectStand::New(ASubjectClass, AParent, AStandStyleName); }
	
};


class PASCALIMPLEMENTATION TFormStand : public TSubjectStand
{
	typedef TSubjectStand inherited;
	
public:
	/* TSubjectStand.Create */ inline __fastcall virtual TFormStand(System::Classes::TComponent* AOwner) : TSubjectStand(AOwner) { }
	/* TSubjectStand.Destroy */ inline __fastcall virtual ~TFormStand() { }
