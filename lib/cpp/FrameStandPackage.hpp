...
// (DO NOT EDIT: machine generated header) 'FrameStandPackage.dpk' rev: 30.00 (Windows)

#ifndef FramestandpackageHPP
#define FramestandpackageHPP
...
namespace Framestandpackage
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Framestandpackage */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRAMESTANDPACKAGE)
using namespace Framestandpackage;
#endif
#pragma pack(pop)
#pragma option pop
