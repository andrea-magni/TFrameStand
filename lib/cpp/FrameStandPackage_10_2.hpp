...
// (DO NOT EDIT: machine generated header) 'FrameStandPackage_10_2.dpk' rev: 32.00 (Windows)

#ifndef Framestandpackage_10_2HPP
#define Framestandpackage_10_2HPP
...
namespace Framestandpackage_10_2
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Framestandpackage_10_2 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRAMESTANDPACKAGE_10_2)
using namespace Framestandpackage_10_2;
#endif
#pragma pack(pop)
#pragma option pop
...
//-- end unit ----------------------------------------------------------------
#endif	// Framestandpackage_10_2HPP
