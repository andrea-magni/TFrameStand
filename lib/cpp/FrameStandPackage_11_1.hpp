...
// (DO NOT EDIT: machine generated header) 'FrameStandPackage_11_1.dpk' rev: 35.00 (Windows)

#ifndef Framestandpackage_11_1HPP
#define Framestandpackage_11_1HPP
...
namespace Framestandpackage_11_1
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Framestandpackage_11_1 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRAMESTANDPACKAGE_11_1)
using namespace Framestandpackage_11_1;
#endif
#pragma pack(pop)
#pragma option pop
...
//-- end unit ----------------------------------------------------------------
#endif	// Framestandpackage_11_1HPP
