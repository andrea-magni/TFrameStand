...
// (DO NOT EDIT: machine generated header) 'FrameStandPackage_12.dpk' rev: 36.00 (Windows)

#ifndef Framestandpackage_12HPP
#define Framestandpackage_12HPP
...
namespace Framestandpackage_12
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Framestandpackage_12 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRAMESTANDPACKAGE_12)
using namespace Framestandpackage_12;
#endif
#pragma pack(pop)
#pragma option pop
